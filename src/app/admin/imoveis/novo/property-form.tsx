        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 border-b border-zinc-100 pb-4">
                    ...
                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Informação Principal</h3>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2 md:col-span-2">
                        ...
                        <Input id="title" className="h-12 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" placeholder="Ex: Moradia T3 com Piscina em Cascais" {...register("title")} />
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="price" type="number" step="0.01" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("price")} />
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 border-b border-zinc-100 pb-4">
                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Características Gerais</h3>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="area_m2" type="number" step="0.01" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("area_m2")} />
                    ...
                    {isResidential && (
                        <>
                            <div className="space-y-2">
                                ...
                                <Input id="bedrooms" type="number" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("bedrooms")} />
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="bathrooms" className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Casas de Banho</Label>
                                <Input id="bathrooms" type="number" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("bathrooms")} />
                            </div>
                        </>
                    )}
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 border-b border-zinc-100 pb-4">
                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Localização</h3>
                </div>
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="municipality" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("municipality")} />
                    ...
                    <div className="space-y-2 md:col-span-2">
                        ...
                        <Input id="address" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("address")} />
                    </div>
                    ...
                    <div className="space-y-4 md:col-span-2 mt-4">
                        ...
                        {geocodeError && (
                            <div className="p-3 bg-red-50/50 border border-red-100 rounded-lg flex items-start gap-2 text-red-600 text-xs mt-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-zinc-50 p-3 rounded-lg border border-zinc-100 flex items-center gap-2">
                                <MapPin className="h-4 w-4 text-zinc-400" />
                                <div className="flex-1">
                                    <span className="text-[9px] font-bold text-zinc-400 uppercase block mb-0.5">Latitude</span>
                                    <span className="text-xs font-mono text-zinc-600 font-bold">{watch("latitude") ? Number(watch("latitude")).toFixed(6) : "---"}</span>
                                </div>
                            </div>
                            <div className="bg-zinc-50 p-3 rounded-lg border border-zinc-100 flex items-center gap-2">
                                <MapPin className="h-4 w-4 text-zinc-400" />
                                <div className="flex-1">
                                    ...
                                    <span className="text-xs font-mono text-zinc-600 font-bold">{watch("longitude") ? Number(watch("longitude")).toFixed(6) : "---"}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
                    <div className="flex items-center gap-3">
                        <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                        <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Extras & Detalhes</h3>
                    </div>
                    <Button
                        type="button"
                        variant="secondary"
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                    {featureFields.map((field, index) => (
                        <div key={field.id} className="flex items-center gap-3 group bg-white p-2 rounded-xl border border-zinc-100 shadow-sm transition-all hover:border-zinc-300">
                            <div className="h-8 w-8 rounded-lg bg-zinc-50 flex items-center justify-center text-zinc-400 font-bold text-xs shrink-0">
                                {index + 1}
                            </div>
                            <Input
                                {...register(`features.${index}` as any)}
                                placeholder="Ex: Cozinha Equipada, Ar Condicionado..."
                                className="flex-1 border-none bg-transparent focus-visible:ring-0 font-medium text-zinc-800 h-9"
                            />
                            <Button
                                type="button"
                                variant="ghost"
                                ...
                                className="text-zinc-300 hover:text-red-500 hover:bg-red-50 transition-colors rounded-lg h-8 w-8 shrink-0"
                            >
                    ...
                    {featureFields.length === 0 && (
                        <div
                            onClick={() => appendFeature("")}
                            className="text-xs text-zinc-400 font-bold uppercase tracking-widest col-span-2 py-8 text-center border-2 border-dashed border-zinc-100 rounded-2xl cursor-pointer hover:bg-zinc-50 hover:border-zinc-200 transition-all"
                        >
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3 border-b border-zinc-100 pb-4">
                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Galeria Fotográfica</h3>
                </div>

                <div className="space-y-6">
                    <div className="flex items-center justify-center w-full">
                        <label htmlFor="images" className="flex flex-col items-center justify-center w-full h-40 border-2 border-dashed border-zinc-200 rounded-2xl cursor-pointer bg-zinc-50 hover:bg-white hover:border-zinc-400 transition-all shadow-inner group">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                <div className="p-3 rounded-full bg-white shadow-sm mb-3 group-hover:scale-110 transition-transform">
                                    <UploadCloud className="w-6 h-6 text-zinc-400" />
                                </div>
                                <p className="mb-1 text-sm text-zinc-900 font-bold uppercase tracking-wider">Arraste fotos ou clique para carregar</p>
            ...
            {/* Secção: Publicação */}
            <div className="space-y-6 mt-12 bg-zinc-50/50 p-8 rounded-2xl border border-zinc-100">
                <div className="flex items-center gap-3 border-b border-zinc-200 pb-4">
                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Visibilidade & Destaques</h3>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    ...
                    <div className="flex items-center space-x-3 pt-6">
                        <div className="bg-white p-3 rounded-xl border border-zinc-200 shadow-sm flex items-center gap-3 w-full cursor-pointer hover:border-zinc-400 transition-colors">
                            <Controller
                                name="featured"
                                control={control}
                                render={({ field }) => (
                            ...
                            />
                            <Label htmlFor="featured" className="cursor-pointer font-bold text-zinc-700 text-sm">Destacar Imóvel na Homepage</Label>
                        </div>
                    </div>
                </div>
            </div>
