...
export function InsuranceForm({ initialData }: { initialData?: any }) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">
                ...
                <div className="space-y-8">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3 border-b border-zinc-100 pb-4">
                            ...
                            <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Informação Geral</h3>
                        </div>

                        <div className="space-y-2">
                            <Label htmlFor="name" className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Nome do Seguro *</Label>
                            <Input id="name" className="h-12 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" placeholder="Ex: Seguro Automóvel" {...register("name")} />
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="h-24 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-medium text-zinc-600 leading-relaxed"
                        ...
                        <div className="grid gap-4 grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <select
                                    id="status"
                                    className="flex h-11 w-full rounded-xl border border-zinc-200 bg-white px-3 py-1 text-sm font-bold text-zinc-700 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900"
                                    {...register("status")}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="display_order" type="number" className="h-11 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-bold text-zinc-900" {...register("display_order")} />
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 pt-6 border-t border-zinc-100">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Vantagens e Coberturas</h3>
                                </div>
                                <Button
                                    type="button"
                                    variant="secondary"
                                    ...
                                    className="rounded-lg h-8 px-3 font-bold text-[10px] uppercase tracking-wider bg-zinc-100 hover:bg-zinc-200 text-zinc-700"
                                >
                                ...
                                {benefitFields.map((field, index) => (
                                    <div key={field.id} className="flex items-center gap-2">
                                        <Input
                                            ...
                                            className="h-10 rounded-xl border-zinc-200 focus-visible:ring-zinc-900 font-medium text-zinc-900 flex-1"
                        ...
                        <div className="space-y-4 pt-6 border-t border-zinc-100">
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                                    <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Perguntas Frequentes</h3>
                                </div>
                                <Button
                                    type="button"
                                    variant="secondary"
                            ...
                            <div className="space-y-4">
                                {faqFields.map((field, index) => (
                                    <div key={field.id} className="p-4 bg-zinc-50 border border-zinc-100 rounded-xl space-y-3 relative group">
                                        <Button
                                            type="button"
                                            variant="ghost"
                                            size="icon"
                                            onClick={() => removeFaq(index)}
                                            className="absolute top-2 right-2 text-zinc-400 hover:text-red-500 hover:bg-red-50 h-8 w-8 opacity-0 group-hover:opacity-100 transition-opacity"
                                        >
                                            <Trash2 className="h-4 w-4" />
                                        </Button>
                                        <div className="space-y-1.5 pr-8">
                                            <Label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Pergunta</Label>
                                            <Input
                                                {...register(`faqs.${index}.q`)}
                                                className="h-10 text-sm font-bold bg-white text-zinc-800 rounded-lg border-zinc-200"
                                                placeholder="Ex: Quanto tempo demora a emissão?"
                                            />
                                        </div>
                                        <div className="space-y-1.5">
                                            <Label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Resposta</Label>
                                            <Textarea
                                                {...register(`faqs.${index}.a`)}
                                                className="h-20 text-sm font-medium bg-white text-zinc-600 rounded-lg border-zinc-200 resize-none"
                        ...
                        <div className="space-y-4 pt-6 border-t border-zinc-100">
                            <div className="flex items-center gap-3 mb-4">
                                <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                                <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Identidade Visual</h3>
                            </div>
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div
                                        ...
                                        className="aspect-video rounded-2xl border-2 border-dashed border-zinc-200 bg-zinc-50 flex flex-col items-center justify-center cursor-pointer hover:bg-white hover:border-zinc-400 transition-all relative overflow-hidden group shadow-inner"
                                    >
                                        {coverPreview ? (
                                            <>
                                            ...
                                            <>
                                                ...
                                                <span className="text-[10px] text-zinc-900 font-bold uppercase tracking-widest">Carregar Capa</span>
                                    ...
                                    >
                                        {iconPreview ? (
                                            ...
                                            <>
                                                ...
                                                <span className="text-[10px] text-zinc-900 font-bold uppercase tracking-widest">Carregar Ícone</span>
                ...
                <div className="space-y-8">
                    <div className="space-y-6">
                        <div className="flex items-center justify-between border-b border-zinc-100 pb-4">
                            <div className="flex items-center gap-3">
                                <div className="h-6 w-1 bg-zinc-900 rounded-full" />
                                <h3 className="font-bold text-zinc-900 uppercase tracking-widest text-xs">Construtor de Formulário</h3>
                            </div>
                            <Button
                                type="button"
                                variant="secondary"
                                ...
                                className="rounded-lg h-9 px-4 font-bold text-[10px] uppercase tracking-wider bg-zinc-100 hover:bg-zinc-200 text-zinc-700"
                            >
                        ...
                        <div className="space-y-4 max-h-[700px] overflow-y-auto pr-2 pb-4 scrollbar-thin scrollbar-thumb-zinc-200">
                            {fields.map((field, index) => {
                                ...
                                return (
                                    <div key={field.id} className="relative bg-white border border-zinc-100 rounded-2xl p-6 shadow-sm hover:border-zinc-300 transition-all group/card">
                                        <div className={`absolute left-3 top-6 transition-colors ${isSystemField ? 'text-zinc-200 cursor-not-allowed' : 'text-zinc-300 hover:text-zinc-600 cursor-move'}`}>
                                        ...
                                        <div className="grid grid-cols-12 gap-5 pl-6">
                                            <div className="col-span-12 sm:col-span-7 space-y-1.5">
                                                ...
                                                <Input
                                                    ...
                                                    className="h-9 text-xs font-mono bg-zinc-50 border-none rounded-lg focus-visible:ring-zinc-900 disabled:opacity-75 disabled:text-zinc-400"
                                            ...
                                            <div className="col-span-12 sm:col-span-5 space-y-1.5">
                                                <Label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Tipo de Campo</Label>
                                                <select
                                                    className="flex h-9 w-full rounded-lg border-none bg-zinc-50 px-3 py-1 text-xs font-bold text-zinc-700 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-900 disabled:opacity-75 disabled:text-zinc-400"
                                            ...
                                            <div className="col-span-12 space-y-1.5">
                                                <Label className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest px-1">Título visível para o cliente</Label>
                                                <Input
                                                    {...register(`form_fields.${index}.label`)}
                                                    className="h-10 text-sm font-bold text-zinc-800 rounded-lg border-zinc-200"
                                                    placeholder="Ex: Matrícula do Veículo"
                                                />
                                            </div>

                                            {fieldType === "select" && (
                                                <div className="col-span-12 space-y-1.5 bg-blue-50/50 p-4 rounded-xl border border-blue-100">
                                                    <Label className="text-[10px] font-bold text-blue-600 uppercase tracking-widest px-1">Opções da Lista (Separadas por vírgula)</Label>
                                                    <Controller
                                                        ...
                                                        render={({ field: { value, onChange } }) => (
                                                            <Input
                                                                ...
                                                                className="h-9 text-xs font-medium bg-white border-blue-200 focus-visible:ring-blue-500 rounded-lg"
                                            ...
                                            <div className="col-span-12 flex items-center space-x-3 pt-4 border-t border-zinc-50">
                                                {isSystemField ? (
                                                ...
                                                <Label htmlFor={`required_${index}`} className={`text-xs font-bold uppercase tracking-wider ${isSystemField ? 'text-brand-primary' : 'text-zinc-500 cursor-pointer'}`}>
                            ...
                            {fields.length === 0 && (
                                <div
                                    onClick={() => append({ id: `campo_${fields.length + 1}`, type: "text", label: "Novo Campo", required: false })}
                                    className="p-10 text-center border-2 border-dashed border-zinc-200 rounded-2xl cursor-pointer hover:bg-zinc-50 hover:border-zinc-400 transition-all bg-zinc-50/30"
                                >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-8 border-t border-zinc-100">
                <Button disabled={isLoading} type="submit" className="w-full sm:w-auto bg-zinc-900 hover:bg-zinc-800 text-white rounded-xl h-12 px-10 font-bold uppercase tracking-widest text-xs shadow-xl">
