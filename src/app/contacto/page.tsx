            ...
            <main className="container mx-auto px-4 py-16 -mt-10">
                <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                    ...
                    <div className="space-y-6">
                        <h2 className="text-2xl font-bold text-brand-dark dark:text-brand-light mb-8">Informações de Contacto</h2>
                        ...
                        <div className="grid sm:grid-cols-2 gap-6">
                            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm">
                                ...
                                <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-2">Morada</h3>
                                <p className="text-sm text-zinc-500 dark:text-zinc-400 leading-relaxed">{settings.footer_address || "Braga, Portugal"}</p>
                            </div>
                            ...
                            <div className="p-6 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm">
                                ...
                                <h3 className="font-bold text-zinc-900 dark:text-zinc-100 mb-2">Horário</h3>
                                <p className="text-sm text-zinc-500 dark:text-zinc-400 whitespace-pre-line leading-relaxed">{settings.footer_hours || "Seg-Sex: 09h-18h"}</p>
                            </div>
                        </div>

                        {/* Contacts Grid */}
                        <div className="p-8 bg-zinc-50 dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800">
                            <div>
                    ...
                    {/* CONTACT FORM */}
                    <div className="bg-white dark:bg-zinc-900 p-8 rounded-xl shadow-lg border border-zinc-200 dark:border-zinc-800 h-fit">
                        <h2 className="text-2xl font-bold mb-8 text-zinc-900 dark:text-zinc-100">Envie uma Mensagem</h2>
