...
export default function TermsPage() {
    return (
        <div className="container mx-auto px-4 py-24 max-w-4xl">
            <h1 className="text-4xl font-bold mb-8 text-brand-dark">Termos e Condições</h1>
            <div className="prose prose-lg dark:prose-invert max-w-none space-y-6 text-zinc-700 dark:text-zinc-300">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-brand-dark mt-8 mb-4">1. Informação de Imóveis</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-brand-dark mt-8 mb-4">2. Mediação de Seguros</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-brand-dark mt-8 mb-4">3. Intermediação de Crédito</h2>
                    <p>
