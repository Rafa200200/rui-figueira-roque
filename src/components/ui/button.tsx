...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-brand-primary disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default:
                    "bg-brand-primary text-white shadow hover:bg-brand-dark",
                destructive:
                    "bg-status-error text-white shadow-sm hover:bg-status-error/90",
                outline:
                    "border border-foreground/20 bg-transparent shadow-sm hover:bg-foreground/5 hover:text-foreground",
                secondary:
                    "bg-brand-light/30 text-brand-dark shadow-sm hover:bg-brand-light/50",
